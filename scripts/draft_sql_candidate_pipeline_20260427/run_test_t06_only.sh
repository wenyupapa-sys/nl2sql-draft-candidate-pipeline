...
echo "[9/12] Generate 6 final candidates at T=0.6 with provider-level queues"
_run_final_batch t06 0.6

echo "[10/12] Repair non-executable candidates locally without gold SQL"
for candidate in \
...
echo "[11/12] Build pairwise schema blocks and select best candidate per question"
...
echo "[12/12] Write predict_test.json and usage summary"
